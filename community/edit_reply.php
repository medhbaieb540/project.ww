...
if (!$is_admin && $reply['user_id'] != $user_id) {
    header("Location: community.php");
    exit();
}
...
.card{max-width:600px;margin:auto;background:#1a1a1a;border:1px solid #1aff8720;border-radius:16px;padding:24px}
h1{color:#1aff87;margin-bottom:18px}
textarea{width:100%;min-height:120px;background:#111;color:#fff;border-radius:12px;border:1px solid #1aff8720;padding:14px}
