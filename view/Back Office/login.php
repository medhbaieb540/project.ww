        ...
        if ($email === "" || $password === "") {
            ...
            try {
                ...
                if (!$user) {
                    ...
                    header("Location: admin.php"); // أو أي صفحة داشبورد
                    exit;
                }
            } catch (Exception $e) {
...
// من هنا وطالع نعرض الـ HTML (سواء GET أو POST مع خطأ)
?>
...
<head>
  ...
  <link rel="stylesheet" href="../Front%20Office/style.css" />
  <!-- <script src="../Front Office/login.js"></script> -->
</head>
<body>
  ...
  <div class="container">
    <div class="logo">
      <img class="logo-img" src="../Front Office/logo.jpg" alt="GameBridge Logo" />
  ...
  <h1>Welcome to GameBridge!</h1>
    ...
    <form id="loginForm" method="POST" action="../../view/Back Office/login.php">
      <div>
      ...
      <div class="row">
        ...
        <a href="forget_password.html" class="forgot">Forgot password?</a>
      </div>
