...
class ReviewController {
    ...
    public function index() {
        ...
        require_once __DIR__ . '/../view/front office/review/list.php';
    }
    ...
    public function create() {
        ...
        require_once __DIR__ . '/../view/front office/review/create.php';
    }
    ...
    public function store() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($errors)) {
                ...
                header('Location: ' . BASE_URL . '/index.php?controller=review&action=create&game_id=' . $data['game_id']);
                exit;
            }
            ...
            try {
                ...
                if ($result) {
                    ...
                    $redirectUrl = BASE_URL . '/index.php?controller=game&action=show&id=' . $data['game_id'];
                ...
                if ($e->getCode() == 23000) {
                    ...
                    // Redirect to game show page even on update
                    $redirectUrl = BASE_URL . '/index.php?controller=game&action=show&id=' . $data['game_id'];
                    header('Location: ' . $redirectUrl);
                } else {
    ...
    public function edit() {
        ...
        require_once __DIR__ . '/../view/front office/review/edit.php';
    }
    ...
    public function show() {
        ...
        require_once __DIR__ . '/../view/front office/review/show.php';
    }
    ...
    public function statistics() {
        ...
        require_once __DIR__ . '/../view/front office/review/statistics.php';
    }
