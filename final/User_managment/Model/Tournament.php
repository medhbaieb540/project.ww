...
class Tournament
{
    ...
    public function create(array $data): bool
    {
        $sql = "INSERT INTO tournaments
                    (name, description, start_date, end_date, reward_id, max_players, image_path)
                VALUES
                    (:name, :description, :start_date, :end_date, :reward_id, :max_players, :image_path)";
    ...
    {
        // ✅ If you want to keep old image when user didn't upload a new one:
        // - If image_path is NOT set, don't update it.
