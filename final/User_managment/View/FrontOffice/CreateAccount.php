<?php
// View/FrontOffice/CreateAccount.php
require_once __DIR__ . '/../../Controller/CreateAccountAction.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class="container">
    ...
    <?php if (!empty($error)): ?>
      <div class="status" style="display:block;"><?= e($error ?? $error) ?></div>
    <?php endif; ?>

    <form id="signupForm" method="POST" action="../../Controller/CreateAccountAction.php" novalidate>
