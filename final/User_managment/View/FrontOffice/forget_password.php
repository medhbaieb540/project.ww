<?php
// View/FrontOffice/forget_password.php
require_once __DIR__ . '/../../Controller/ForgotPasswordAction.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class="container">
    ...
    <form id="resetForm" method="POST" action="../../Controller/ForgotPasswordAction.php">
      <div>
      ...
      <div id="resetStatus" class="status">
